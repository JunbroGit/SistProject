...
public class SwingRadioCheck_02 extends JFrame implements ActionListener{
	...
	Color [] colors= {Color.RED,Color.BLUE,Color.GREEN,Color.LIGHT_GRAY};
	JLabel lblMessage;
	...
	public void initDesign()
	{
		...
		String [] str1= {"Red","Blue","Green","Light_Gray"};
		...
		{
			rb[i]=new JRadioButton(str1[i],i==0?true:false); //라디오버튼생성(텍스트,기본체크)
	...
	public static void main(String[] args) {
		...
		new SwingRadioCheck_02("스윙 라디오 체크_2");
	}
