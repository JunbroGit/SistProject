...
public class Format_01 {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat sfd1=new SimpleDateFormat("yyyy-MM-dd HH:mm");
		...
		//NumberFormat 숫자를 문자열로 변환하여 출력(컴마나 소수점자리수 저정)
		int money=21546486;
		double num=89.5477;
		
		NumberFormat nf1=NumberFormat.getCurrencyInstance(); //화페단위와 컴마 제공
