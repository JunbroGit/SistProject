...
public class SwingComponent_09 extends JFrame{
	...
	Icon icon1=new ImageIcon("C:\\sist0103\\image\\swingimage\\img1.gif");
	Icon icon2=new ImageIcon("C:\\sist0103\\image\\swingimage\\img3.gif");
	...
	public void initDesign()
	{
		...
		lbl4.setBorder(new LineBorder(Color.PINK, 3)); //색상,선굵기
		this.add(lbl4);
	}
