		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<select style="width: 200px;" class="form-control" required="required" name="category">
						<option value="토토로" selected="selected">토토로</option>
						<option value="고양이버스">고양이버스</option>
			...
			<tr>
				<td colspan="2" align="center">
					...
					<button type="button" class="btn btn-success" style="width: 100px;" onclick="location.href='index.jsp?main=shop/shopList.jsp'">상품목록</button>
				</td>
			</tr>
		</table>
	</form>
