...
<body>
<!-- 이미지 미리보기 -->
<img id="showimg" style="position: absolute; left: 800px; top: 100px; max-width: 200px;" src="<%=(dto.getPhotoname()==null?"":"save/"+dto.getPhotoname())%>">
	...
	<input type="hidden" name="currentPage" value="<%=currentPage%>">
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<button type="submit" class="btn btn-success" style="width: 100px; height: 100px;">수정</button>
				</td>
			</tr>
		</table>
	</form>
