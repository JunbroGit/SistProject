		...
		<table class="table table-bordered">
			<caption align="top"><b>개인신상정보 수정</b></caption>
				...
				<tr>
					...
					<td>
						<input type="date" name="birth" required="required" class="form-control" style="width: 150px;" value="<%=dto.getBirth()%>">
					</td>
				</tr>
				...
				<tr>
					<td colspan="2" align="center">
						...
						<input type="button" value="되돌아가기" class="btn btn-outline-success" onclick="location.href='infoList.jsp'">
					</td>
				</tr>
		</table>
	</form>
