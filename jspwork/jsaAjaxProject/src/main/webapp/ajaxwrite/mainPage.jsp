	...
	<form id="addfrm">
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<input type="text" name="writer" id="writer" class="form-control" style="width: 130px;">
				</td>
			</tr>
			<tr>
				<th width="100" class="table-warning">제목</th>
				<td>
					<input type="text" name="subject" id="subject" class="form-control" style="width: 250px;">
				</td>
			</tr>
			<tr>
				<th width="100" class="table-warning">내용</th>
				<td>
					<textarea name="story" id="story" class="form-control" style="width: 300px; height: 100px;"></textarea>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<select id="selimage" class="form-control" style="width: 100px;">
