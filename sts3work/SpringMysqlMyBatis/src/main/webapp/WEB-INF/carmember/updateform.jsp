 ...
 <input type="hidden" name="num" value="${dto.num }">
	<table class="table table-bordered" >
		...
		<tr>
			...
			<td width="200">
				<input type="text" name="addr" style="width: 250px;" required="required" class="form-control" value="${dto.addr }">
			</td>
		</tr>		
		<tr>
			<td colspan="2" align="center">
				<button type="submit" class="btn btn-outline-success">DB수정</button>
				<button type="button" class="btn btn-outline-success" onclick="location.href='list'">고객목록</button>
			</td>
		</tr>
	</table>
</form>
