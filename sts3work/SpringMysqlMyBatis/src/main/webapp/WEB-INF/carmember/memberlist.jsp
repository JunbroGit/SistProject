...
<div style="margin: 50px 100px; width: 800px;">
		...
		<button type="button" class="btn btn-success" style="width: 100px;" onclick="location.href='../samsung/list'">차목록</button>
				...
				<c:forEach var="dto" items="${list}" varStatus="i">
					<tr align="center">
						...
						<td>
							...
							<button type="button" class="btn btn-outline-success btn-sm" onclick="location.href='delete?num=${dto.num}'">삭제</button>					
						</td>
					</tr>
				</c:forEach>
			</table>
