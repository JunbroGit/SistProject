	...
	<form action="insert" method="post">
		<table class="table table-boardered">
			...
			<tr>
				<th>색상</th>
				<td>
					<input type="color" name="sangcolor" class="form-control" style="width: 200px;" required="required">
				</td>
			</tr>
			<tr>
				<th>입고일</th>
				<td>
					<input type="date" name="sangipgo" class="form-control" style="width: 250px;" required="required">
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<input type="submit" class="btn btn-info" value="상품등록">
