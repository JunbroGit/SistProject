	...
	<input type="hidden" name="num" value="${dto.num }">
		<table class="table table-boardered">
			...
			<tr>
				<th>색상</th>
				<td>
					<input type="color" name="sangcolor" class="form-control" style="width: 200px;" required="required" value="${dto.sangcolor }">
				</td>
			</tr>
			<tr>
				<th>입고일</th>
				<td>
					<input type="date" name="sangipgo" class="form-control" style="width: 250px;" required="required" value="${dto.sangipgo }">
				</td>
			</tr>
			<tr>
