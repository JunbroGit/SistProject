   ...
   <form action="insert" method="post" enctype="multipart/form-data">
     <table class="table table-bordered">
        <tr>
          ...
          <td>
            <input type="text" name="sang" required="required" class="form-control" style="width: 130px;">
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="dan" required="required" class="form-control" style="width: 120px;">
          </td>
        </tr>
